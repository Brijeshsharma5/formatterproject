		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#testcomformatterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testcomformatterproject-display": {
								"semanticObject": "testcomformatterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.com.formatterproject",
									"url": sap.ui.require.toUrl("test/com/formatterproject")
								}
							}
						}
					}
